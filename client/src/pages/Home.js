    ...
    return (
      <div class="container">
        <Navbar/>
          ...
          <div className="lg:w-11/12 lg:ml-24 md:ml-12 lg:columns-2 justify-center sm:columns-1  text-center">
          <h1 className="text-3xl lg:text-5xl lg:text-left sm:text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500" style={{fontWeight:"bolder"}}>A Cut Above the Rest</h1>
              <p className="lg:w-3/4 sm:w-1 text-transparent lg:text-left sm:text-center bg-clip-text bg-gradient-to-b from-indigo-800 via-purple-600 via-purple-500 to-orange-500 mb-10 md:mb-0" style={{fontWeight:"bolder"}}>Not all tile is set the same. And not all tile companies work the same. At Sonoran Sunset Tile, we strive to bring the best service possible to your home. Whether it’s complicated designs, speed of work, or quality of the final product, at Sonoran Sunset Tile we focus on making your experience the best possible. </p>
              
          <h1 className="text-3xl lg:text-5xl lg:text-left sm:text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500" style={{fontWeight:"bolder"}}>Over 35 Years of Experience</h1>
              <p className="lg:w-3/4 sm:w-1 text-transparent lg:text-left sm:text-center bg-clip-text bg-gradient-to-b from-indigo-800 via-purple-600 via-purple-500 to-orange-500" style={{fontWeight:"bolder"}}>Founded in 1994, At Sonoran Sunset Tile, We are proud to share our over 25 years of expertese so you can make the most informed decision when your are deciding on flooring. Whether it is a new home, or remodeling your current residence. We are here to help. </p>
              </div>
        <br/>
